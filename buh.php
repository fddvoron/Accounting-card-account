...
echo '<tr><td colspan="4" align="right">ВСЕГО ПО ТРАНЗАКЦИИ: '.$totaltr.' '.$cur.'</td></tr>';
echo '</table>';
...
echo '<tr><td align="center">Номер счета</td><td colspan="2" align="center">'.$accountid.'</td></tr>';
...
echo '<tr><td colspan="2" align="center">Расходная транзакция</td></tr>';
echo '<tr><td align="center"><select name="idtsform" size = "1">';
...
echo '</select></td>';
echo '<td align="center"><input name="outform" type="text" size="10" maxlength="10" placeholder="0.00" required /></td></tr>';
...
{
DB_InsertOutcomeTransaction($accountid);
echo '<meta http-equiv="refresh" content="0;URL=buh.php">';
}

if(isset($_POST['InSubmit']))
{
DB_InsertIncomeTransaction($accountid);
echo '<meta http-equiv="refresh" content="0;URL=buh.php">';
}
